...
export const INSTRUMENTS: Instrument[] = ['Kick', 'Snare', 'Hi-hat (Closed)', 'Hi-hat (Open)', 'Clap', 'Tom', 'Rimshot', 'Cowbell', 'Cymbal', 'Shaker', '808', 'Congas', 'Violin', 'Trumpet', 'Pianos', 'High Pitch Piano'];
